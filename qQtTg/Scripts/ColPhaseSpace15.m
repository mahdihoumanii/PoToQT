...
Module[{p1,p, p2, p3, p4, K, n1,n2, p34, p34sq,
  sqp34sq, sintheta, boostp, kt,ktsq,pp2 },
  p =  (1/2)*{1, 1, 0,0};
  p2 = (1/2)*{1,-1, 0, 0};
  kt = {0,0,1,0};
  pp2 = p[[1]] p2[[1]]-p[[2]] p2[[2]]-p[[3]] p2[[3]]-p[[4]] p2[[4]];
  ktsq = -1;
  K = -((1-z)p - lambda*kt -lambda^2 ktsq/pp2/2/(1-z)*p2) ;
  p1 = (z)p + lambda*kt -lambda^2 ktsq/pp2/2/(z)*p2; 
  p34 = p1 + p2 - K;
